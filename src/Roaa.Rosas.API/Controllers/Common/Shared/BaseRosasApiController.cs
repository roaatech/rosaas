...
namespace Roaa.Rosas.Framework.Controllers.Common
{
    ...
    {
        public const string TenantAdminIdentityApiRoute = "api/identity/tadmin/v1/[controller]";
        public const string ProductOwnerAdminIdentityApiRoute = "api/identity/product-owner-admin/v1/[controller]";
