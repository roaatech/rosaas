...
namespace Roaa.Rosas.Infrastructure.Persistence.Migrations.ProductOwner
{
    ...
    [Migration("20240626075222_AddDescriptionColumnToProductOwner")]
    partial class AddDescriptionColumnToProductOwner
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Roaa.Rosas.Domain.Entities.Management.Product", b =>
                {
                    ...
                    b.Property<bool>("ApplySubscriptionDowngradeByExternalSystemAction")
                        .HasColumnType("tinyint(1)");

                    b.Property<bool>("ApplySubscriptionUpgradeByExternalSystemAction")
                        .HasColumnType("tinyint(1)");
            ...
            modelBuilder.Entity("Roaa.Rosas.Domain.Entities.Management.ProductOwner", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Roaa.Rosas.Domain.Entities.Management.SubscriptionRenewal", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
                    ...
                    b.Property<bool>("IsContinuousRenewal")
                        .HasColumnType("tinyint(1)");
                    ...
                    b.Property<DateTime>("SubscriptionRenewalDate")
                        .HasColumnType("datetime");
                    ...
                    b.ToTable("rosas_subscription_renewals", (string)null);
                });

            modelBuilder.Entity("Roaa.Rosas.Domain.Entities.Management.SubscriptionRenewalHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.Property<Guid>("RenewalEnabledByUserId")
                        .HasColumnType("char(36)");

                    b.Property<DateTime>("RenewalEnabledDate")
                        .HasColumnType("datetime");
                    ...
                    b.ToTable("rosas_subscription_renewal_histories", (string)null);
                });
            ...
            modelBuilder.Entity("Roaa.Rosas.Domain.Entities.Management.TrialSubscription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("rosas_trial_subscriptions", (string)null);
                });

            modelBuilder.Entity("Roaa.Rosas.Domain.Entities.Management.WebhookEndpoint", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("rosas_webhook_endpoints", (string)null);
                });

            modelBuilder.Entity("Roaa.Rosas.Domain.Entities.Management.WebhookEndpointEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("RosasWebhookEvents", (string)null);
                });
            ...
            modelBuilder.Entity("Roaa.Rosas.Domain.Entities.Management.Product", b =>
                {
                    b.HasOne("Roaa.Rosas.Domain.Entities.Management.ProductOwner", "Client")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("Roaa.Rosas.Domain.Entities.Management.SubscriptionRenewal", b =>
                {
                    b.HasOne("Roaa.Rosas.Domain.Entities.Management.Subscription", "Subscription")
                        .WithOne("SubscriptionRenewal")
                        .HasForeignKey("Roaa.Rosas.Domain.Entities.Management.SubscriptionRenewal", "Id")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Roaa.Rosas.Domain.Entities.Management.TrialSubscription", b =>
                {
                    b.HasOne("Roaa.Rosas.Domain.Entities.Management.Subscription", "Subscription")
                        .WithOne("Trial")
                        .HasForeignKey("Roaa.Rosas.Domain.Entities.Management.TrialSubscription", "SubscriptionId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Roaa.Rosas.Domain.Entities.Management.WebhookEndpointEvent", b =>
                {
                    b.HasOne("Roaa.Rosas.Domain.Entities.Management.WebhookEndpoint", "WebhookEndpoint")
                        .WithMany("EventsToListen")
