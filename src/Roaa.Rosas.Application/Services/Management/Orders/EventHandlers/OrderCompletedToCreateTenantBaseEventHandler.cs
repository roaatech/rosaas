...
{
    public abstract class OrderCompletedToCreateTenantBaseEventHandler<TEventHandler, TEventModel> where TEventModel : OrderCompletedBaseEvent
    {
        private readonly ILogger<TEventHandler> _logger;
        ...
        public OrderCompletedToCreateTenantBaseEventHandler(ITenantWorkflow workflow,
        ...
        public async Task Handle(TEventModel @event, CancellationToken cancellationToken)
        {
