...
{
    public class TenantAvailabilityChangedToUnhealthyEventHandler : BaseWebhookEventHandler<TenantAvailabilityChangedToUnhealthyEvent, dynamic>
    {
        protected override WebhookEvents EventType => WebhookEvents.TenantAvailabilityChangedToUnhealthy;



        public TenantAvailabilityChangedToUnhealthyEventHandler(IServiceScopeFactory serviceScopeFactory)
