...
{
    public class ExternalSystemIsBeingProvisionedTenantResourcesEventHandler : BaseWebhookEventHandler<ExternalSystemIsBeingProvisionedTenantResourcesEvent, dynamic>
    {
        protected override WebhookEvents EventType => WebhookEvents.ExternalSystemIsBeingProvisionedTenantResources;



        public ExternalSystemIsBeingProvisionedTenantResourcesEventHandler(IServiceScopeFactory serviceScopeFactory)
