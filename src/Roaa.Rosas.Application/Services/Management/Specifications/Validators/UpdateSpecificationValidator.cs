...
{
    public class UpdateSpecificationValidator : AbstractValidator<UpdateSpecificationModel>
    {
        public UpdateSpecificationValidator(IIdentityContextService identityContextService)
        {
