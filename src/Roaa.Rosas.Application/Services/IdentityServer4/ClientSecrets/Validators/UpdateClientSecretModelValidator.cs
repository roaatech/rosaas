...
{
    public class UpdateClientSecretModelValidator : AbstractValidator<UpdateClientSecretModel>
    {
        public UpdateClientSecretModelValidator(IIdentityContextService identityContextService)
        {
